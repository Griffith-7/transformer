...
# ==========================================
# HARDENED TRAINING: Spiking Lorentz (SLT)
# ==========================================
...
def main():
    ...
    # RiemannianAdam is REQUIRED because the model contains geoopt.Lorentz params (the manifold)
    ...
    for epoch in range(epochs):
        for batch_idx, (x, y) in enumerate(train_loader):
            ...
            # Gradient Clipping: Prevents NaN in curved geometry
